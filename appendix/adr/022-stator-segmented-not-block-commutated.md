...
Both branches are now priced. `analysis/owner_decisions.py` to `results/owner_decisions.json`,
...
*(P29's own 2026-07-31 estimate of "21.2 % to roughly 24.4 %" is superseded. It predates the

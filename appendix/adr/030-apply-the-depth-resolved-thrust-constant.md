...
`V_FLEET` moves 16.2 to 15.8 m/s, holding ADR-014's *fraction* rather than its number: 98.57 %
...
Kill criterion 1 gets worse: crossed by 3.2x to 3.5x. Criteria 2 and 3 are unchanged and still
crossed.

...
| From → to | Crossing condition |
|---|---|
| **lab → main** | Its acceptance bands have been declared **before** its script existed, and run. This is unchanged and is not negotiable |
| **main → paper/thesis** | **Stable, effective and reliable against the problem statement.** Not "interesting", not "better" — *reliable* |

...
## Alternatives
- Publish only when clean. Rejected: a repository with no defects listed is either trivial
  or dishonest, and a reader cannot tell which.
- Keep private. Rejected: it is a portfolio, and a private portfolio is not one.

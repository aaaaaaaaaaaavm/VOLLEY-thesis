...
The closed installed envelope is **1839 × 530 × 940 mm** (`cad/parameters.json`). The 1839 mm
...
|---|---:|---:|---:|---:|---:|
| **As designed** | 1839 mm | 1300 mm | **16.388 m/s** | 537 J | **×1.62** |
| Fit ESPA Grande, as drawn | 1270 mm | 731 mm | **12.286 m/s** (−25.0 %) | 302 J | ×1.44 |
| Fit ESPA Grande, 150 mm repackaged | 1270 mm | 881 mm | 13.495 m/s (−17.7 %) | 364 J | ×1.49 |
...
2. **Shortening spends the headline number to enter a market the architecture was not designed
   ...
   the comparison against a spring. The 6.6× spring comparator becomes about 5×.

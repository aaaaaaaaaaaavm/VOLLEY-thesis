...
2. Closed-loop bandwidth <= one third of the track's first mode, currently 109 Hz to 36.3 Hz.
...
The gain falls by a factor of 18 and the dispersion does not move, 0.0271 to 0.0267 m/s. That

...
| GOV-05 | **Seventeen ADRs** | `docs/adr/`. `DECISION_LOG.md` is not superseded, its prose became the Context sections. 012-017 record decisions never written down anywhere, including the three second-order effects of the sled-mass change that were not obvious at the time. |

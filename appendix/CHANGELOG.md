...
| GOV-05 | `docs/WHY.md` | A statement of intent, and the reason the programme is split in two: a named tendency to spiral into redesign, structurally constrained rather than resisted by willpower. |

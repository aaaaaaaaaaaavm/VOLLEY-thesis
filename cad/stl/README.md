...
|---|---|---|---|---|
| `EMOCD_Assembly_Gen3.stl` | `../step/gen3/EMOCD_Assembly_Gen3.step` | 40 mm max | 50,692 | 1995 × 530 × 940 mm |
| `EMOCD_Sled_Gen3.stl` | `../step/gen3/EMOCD_Sled_Gen3.step` | 8 mm max | 23,332 | 616 × 172 × 140 mm |
...
matches exactly at 616 × 172 × 140 mm. The assembly measures 1995 mm in X against a

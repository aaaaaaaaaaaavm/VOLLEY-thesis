...
because the tube itself grew 0.311 to 1.140 kg.
...
- It does not size a real vessel. The store mass uses A39's PV/W = 15 000 m figure of
  merit and A39's own run sheet says real 1.7 L / 200 bar vessels are underestimated 4-6x by
...
A smaller bottle relaxes faster and the margin halves, exactly as predicted, and 7.39x is still
...
The gas gets colder, though. Minimum reservoir temperature falls 201.9 to 161.3 K, against
...
> last fill.
>
> The resizing improves it, 14.391 to 11.516 s, because a smaller bottle at the same storage
...
- It does not size a real vessel. A39's PV/W = 15 000 m underestimates real 1.7 L / 200 bar
  vessels 4-6x by A39's own admission. The absolute store mass is soft; the ratio between two
